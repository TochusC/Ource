...
void HariMain(void)
{
    ...
    putfonts8_asc(buf_back, binfo->scrnx,  79, 79, COL8_0000FF, "Welcome To Ource OS");
    putfonts8_asc(buf_back, binfo->scrnx, 81, 81, COL8_FF0000, "Welcome To Ource OS");
    putfonts8_asc(buf_back, binfo->scrnx, 80, 80, COL8_FFFFFF, "Welcome To Ource OS");
