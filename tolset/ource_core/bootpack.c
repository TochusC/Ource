...
void HariMain(void)
{
    ...
    putfonts8_asc(binfo->vram, binfo->scrnx, 48, 48, COL8_000000, "Welcome to OURCE OS!");
    putfonts8_asc(binfo->vram, binfo->scrnx, 49, 49, COL8_FFFFFF, "Welcome to OURCE OS!");

    putfonts8_asc(binfo->vram, binfo->scrnx, 120, 120, COL8_000000, "Powered by TochusC(UPC)");
    putfonts8_asc(binfo->vram, binfo->scrnx, 120, 120, COL8_FFFFFF, "Powered by TochusC(UPC)");
